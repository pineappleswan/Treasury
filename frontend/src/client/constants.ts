...
const CONSTANTS = {
  ...
  ENCRYPTED_CHUNK_EXTRA_DATA_SIZE: 0, // Calculated below...
  ENCRYPTED_CHUNK_SIZE: 0, // Calculated below...
...
CONSTANTS.ENCRYPTED_CHUNK_EXTRA_DATA_SIZE = 4 + CONSTANTS.NONCE_BYTE_LENGTH + CONSTANTS.POLY1305_TAG_BYTE_LENGTH;
...
CONSTANTS.ENCRYPTED_CHUNK_SIZE = CONSTANTS.CHUNK_DATA_SIZE + CONSTANTS.ENCRYPTED_CHUNK_EXTRA_DATA_SIZE;
